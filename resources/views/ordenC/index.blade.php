@extends('layouts.app')
@section('title','Ordenes - '.config('app.name'))
  ...
  <div class="row">
      ...
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number">{{ count($ordenes) }}</span>
        </div>
        <!-- /.info-box-content -->
      </div>
      <!-- /.info-box -->
	  	...
	  	<div class="col-md-12">
	    	<div class="box box-danger">
		      <div class="box-header with-border">
		        <h3 class="box-title"><i class="fa fa-users"></i> ORdenes</h3>
		        <span class="pull-right">
							<a href="{{ route('ordencompra.create') }}" class="btn btn-flat btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Nueva Orden</a>
						</span>
		      </div>
      			<div class="box-body">
						...
						<tbody class="text-center">
							@foreach($ordenes as $d)
								<tr>
									...
									<td>{{strtoupper($d->proveedor->razon_social)}}</td>
									<td>
