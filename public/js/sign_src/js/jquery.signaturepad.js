...
$.fn.signaturePad.defaults = {
  ...
  , errorMessage : 'Por favor, inserte su nombre' // The error message displayed on invalid submission
  , errorMessageDraw : 'Por favor, debe firmar obligatoriamente' // The error message displayed when drawOnly and no signature is drawn
